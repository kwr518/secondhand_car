...
├── 📄 new_ml2.py # 모델 성능 개선 및 재학습 코드 
├── 📄 noise.py # 데이터 증강(Data Augmentation) 로직 (노이즈 주입) 
├── 📄 gan.py # (실험적) GAN 기반 데이터 생성 스크립트 
├── 📄 conversion.py # 데이터 전처리 및 형식 변환 유틸리티 
...
| :---: | :---: |
| ![Main Screen](https://via.placeholder.com/400x300?text=Insert+Main+Screen+Image) | ![AI Result](https://via.placeholder.com/400x300?text=Insert+AI+Result+Image) |
